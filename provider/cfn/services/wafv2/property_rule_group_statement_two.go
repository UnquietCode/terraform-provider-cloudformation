...
func propertyRuleGroupStatementTwo(extras...string) *schema.Resource {
	var count int64 = 0
	...
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"rate_based_statement": {
				Type: schema.TypeList,
				Elem: propertyRuleGroupRateBasedStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
			"and_statement": {
				Type: schema.TypeList,
				Elem: propertyRuleGroupAndStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
			"or_statement": {
				Type: schema.TypeList,
				Elem: propertyRuleGroupOrStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
			"not_statement": {
				Type: schema.TypeList,
				Elem: propertyRuleGroupNotStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
		},
