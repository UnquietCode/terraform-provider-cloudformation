...
func propertyWebACLStatementTwo(extras...string) *schema.Resource {
	var count int64 = 0
	...
	return &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"rate_based_statement": {
				Type: schema.TypeList,
				Elem: propertyWebACLRateBasedStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
			"and_statement": {
				Type: schema.TypeList,
				Elem: propertyWebACLAndStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
			"or_statement": {
				Type: schema.TypeList,
				Elem: propertyWebACLOrStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
			"not_statement": {
				Type: schema.TypeList,
				Elem: propertyWebACLNotStatementTwo(),
				Optional: true,
				MaxItems: 1,
			},
		},
