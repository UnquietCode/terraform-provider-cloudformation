...
func resourceBucketCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::S3::Bucket", data, meta)
}

func resourceBucketRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::S3::Bucket", data, meta)
}

func resourceBucketUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::S3::Bucket", data, meta)
}

func resourceBucketDelete(data *schema.ResourceData, meta interface{}) error {
