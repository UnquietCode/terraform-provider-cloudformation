...
func dresourceS3BucketCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::S3::Bucket", ResourceS3Bucket(), data, meta)
}

func dresourceS3BucketRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::S3::Bucket", ResourceS3Bucket(), data, meta)
}

func dresourceS3BucketUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::S3::Bucket", ResourceS3Bucket(), data, meta)
}

func dresourceS3BucketDelete(data *schema.ResourceData, meta interface{}) error {
