...
func resourceFunctionCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::Lambda::Function", data, meta)
}

func resourceFunctionRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::Lambda::Function", data, meta)
}

func resourceFunctionUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::Lambda::Function", data, meta)
}

func resourceFunctionDelete(data *schema.ResourceData, meta interface{}) error {
