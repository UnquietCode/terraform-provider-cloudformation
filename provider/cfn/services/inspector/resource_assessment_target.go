...
func resourceAssessmentTargetCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::Inspector::AssessmentTarget", data, meta)
}

func resourceAssessmentTargetRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::Inspector::AssessmentTarget", data, meta)
}

func resourceAssessmentTargetUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::Inspector::AssessmentTarget", data, meta)
}

func resourceAssessmentTargetDelete(data *schema.ResourceData, meta interface{}) error {
