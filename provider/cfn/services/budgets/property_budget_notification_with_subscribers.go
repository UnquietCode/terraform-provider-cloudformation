...
var budgetNotificationWithSubscribersProperties map[string]string = map[string]string{
	"subscribers": "Subscribers",
	"notification": "Notification",
}

func propertyBudgetNotificationWithSubscribers(extras...string) *schema.Resource {
	var count int64 = 0
