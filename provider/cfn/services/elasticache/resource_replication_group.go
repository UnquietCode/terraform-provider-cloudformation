...
func resourceReplicationGroupCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::ElastiCache::ReplicationGroup", data, meta)
}

func resourceReplicationGroupRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::ElastiCache::ReplicationGroup", data, meta)
}

func resourceReplicationGroupUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::ElastiCache::ReplicationGroup", data, meta)
}

func resourceReplicationGroupDelete(data *schema.ResourceData, meta interface{}) error {
