...
func ResourceEC2Fleet() *schema.Resource {
	return &schema.Resource{
		Create: resourceEC2FleetCreate,
		Read:   resourceEC2FleetRead,
		Update: resourceEC2FleetUpdate,
		Delete: resourceEC2FleetDelete,
...
func resourceEC2FleetCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::EC2::EC2Fleet", data, meta)
}

func resourceEC2FleetRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::EC2::EC2Fleet", data, meta)
}

func resourceEC2FleetUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::EC2::EC2Fleet", data, meta)
}

func resourceEC2FleetDelete(data *schema.ResourceData, meta interface{}) error {
