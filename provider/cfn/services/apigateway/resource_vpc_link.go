...
func resourceVpcLinkCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::ApiGateway::VpcLink", data, meta)
}

func resourceVpcLinkRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::ApiGateway::VpcLink", data, meta)
}

func resourceVpcLinkUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::ApiGateway::VpcLink", data, meta)
}

func resourceVpcLinkDelete(data *schema.ResourceData, meta interface{}) error {
