...
func resourceMaintenanceWindowCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::SSM::MaintenanceWindow", data, meta)
}

func resourceMaintenanceWindowRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::SSM::MaintenanceWindow", data, meta)
}

func resourceMaintenanceWindowUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::SSM::MaintenanceWindow", data, meta)
}

func resourceMaintenanceWindowDelete(data *schema.ResourceData, meta interface{}) error {
