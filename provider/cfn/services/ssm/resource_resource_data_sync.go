...
func ResourceResourceDataSync() *schema.Resource {
	return &schema.Resource{
		...
		Update: resourceResourceDataSyncUpdate,
...
func resourceResourceDataSyncCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::SSM::ResourceDataSync", data, meta)
}

func resourceResourceDataSyncRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::SSM::ResourceDataSync", data, meta)
}

func resourceResourceDataSyncUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::SSM::ResourceDataSync", data, meta)
}

func resourceResourceDataSyncDelete(data *schema.ResourceData, meta interface{}) error {
