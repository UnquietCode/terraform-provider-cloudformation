...
var clusterInstanceFleetProvisioningSpecificationsProperties map[string]string = map[string]string{
	"spot_specification": "SpotSpecification",
}

func propertyClusterInstanceFleetProvisioningSpecifications(extras...string) *schema.Resource {
	var count int64 = 0
