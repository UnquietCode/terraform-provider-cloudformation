...
func resourceReplicationInstanceCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::DMS::ReplicationInstance", data, meta)
}

func resourceReplicationInstanceRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::DMS::ReplicationInstance", data, meta)
}

func resourceReplicationInstanceUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::DMS::ReplicationInstance", data, meta)
}

func resourceReplicationInstanceDelete(data *schema.ResourceData, meta interface{}) error {
