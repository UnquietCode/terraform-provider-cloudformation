...
func resourceStateMachineCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::StepFunctions::StateMachine", data, meta)
}

func resourceStateMachineRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::StepFunctions::StateMachine", data, meta)
}

func resourceStateMachineUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::StepFunctions::StateMachine", data, meta)
}

func resourceStateMachineDelete(data *schema.ResourceData, meta interface{}) error {
