...
func resourceDatabaseCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::Glue::Database", data, meta)
}

func resourceDatabaseRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::Glue::Database", data, meta)
}

func resourceDatabaseUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::Glue::Database", data, meta)
}

func resourceDatabaseDelete(data *schema.ResourceData, meta interface{}) error {
