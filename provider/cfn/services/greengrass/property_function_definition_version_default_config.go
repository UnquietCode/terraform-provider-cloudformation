...
var functionDefinitionVersionDefaultConfigProperties map[string]string = map[string]string{
	"execution": "Execution",
}

func propertyFunctionDefinitionVersionDefaultConfig(extras...string) *schema.Resource {
	var count int64 = 0
