...
var functionDefinitionDefaultConfigProperties map[string]string = map[string]string{
	"execution": "Execution",
}

func propertyFunctionDefinitionDefaultConfig(extras...string) *schema.Resource {
	var count int64 = 0
