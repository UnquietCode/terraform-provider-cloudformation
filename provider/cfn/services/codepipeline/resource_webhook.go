...
func resourceWebhookCreate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceCreate("AWS::CodePipeline::Webhook", data, meta)
}

func resourceWebhookRead(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceRead("AWS::CodePipeline::Webhook", data, meta)
}

func resourceWebhookUpdate(data *schema.ResourceData, meta interface{}) error {
	return plugin.ResourceUpdate("AWS::CodePipeline::Webhook", data, meta)
}

func resourceWebhookDelete(data *schema.ResourceData, meta interface{}) error {
